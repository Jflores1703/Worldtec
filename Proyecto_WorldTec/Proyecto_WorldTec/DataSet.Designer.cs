    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.relationProducto_Categoria = new global::System.Data.DataRelation("Producto_Categoria", new global::System.Data.DataColumn[] {
                        this.tableProducto.CategoriaIdColumn}, new global::System.Data.DataColumn[] {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductoRow AddProductoRow(string Descripcion, double Precio, int Existencia, int CategoriaId, byte[] Foto, bool Activo) {
...
namespace Proyecto_WorldTec.DataSetTableAdapters {
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Producto] ([Descripcion], [Precio], [Existencia], [CategoriaId], [Foto], [Activo]) VALUES (@Descripcion, @Precio, @Existencia, @CategoriaId, @Foto, @Activo);
SELECT Id, Descripcion, Precio, Existencia, CategoriaId, Foto, Activo FROM Producto WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Producto] SET [Descripcion] = @Descripcion, [Precio] = @Precio, [Existencia] = @Existencia, [CategoriaId] = @CategoriaId, [Foto] = @Foto, [Activo] = @Activo WHERE (([Id] = @Original_Id) AND ([Precio] = @Original_Precio) AND ([Existencia] = @Original_Existencia) AND ([CategoriaId] = @Original_CategoriaId) AND ([Activo] = @Original_Activo));
SELECT Id, Descripcion, Precio, Existencia, CategoriaId, Foto, Activo FROM Producto WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Proyecto_WorldTec.Properties.Settings.Default.POS_L3_01a97604d74f47988cf652adfd5561b9ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Descripcion, Precio, Existencia, CategoriaId, Foto, Activo FROM dbo.Pr" +
                "oducto";
        ...
        public virtual int Insert(string Descripcion, double Precio, int Existencia, int CategoriaId, byte[] Foto, bool Activo) {
            if ((Descripcion == null)) {
        ...
        public virtual int Update(string Descripcion, double Precio, int Existencia, int CategoriaId, byte[] Foto, bool Activo, int Original_Id, double Original_Precio, int Original_Existencia, int Original_CategoriaId, bool Original_Activo, int Id) {
            if ((Descripcion == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Descripcion, double Precio, int Existencia, int CategoriaId, byte[] Foto, bool Activo, int Original_Id, double Original_Precio, int Original_Existencia, int Original_CategoriaId, bool Original_Activo) {
            return this.Update(Descripcion, Precio, Existencia, CategoriaId, Foto, Activo, Original_Id, Original_Precio, Original_Existencia, Original_CategoriaId, Original_Activo, Original_Id);
        }
    }
